...
public class GSM
{
	...
	{
		currentState = null;
		if(state == StateHolder.menuState) currentState = new MenuState(new SingleStateBuilder(), "/textures/states/Menu.png", "Menu", this);
		if(state == StateHolder.passwordState) currentState = new PasswordState(new SingleStateBuilder(), "/textures/states/Password.png", "Password", this);
		if(state == StateHolder.starterStage) currentState = new StarterStage(new DualStateBuilder(), null, "Starter", this);
		if(currentState.getBuildState().stateType().equals("Dual")){pastState = new Inventory(new DualStateBuilder(), "/textures/states/Inventory.png", "Inventory", this);}
	}
