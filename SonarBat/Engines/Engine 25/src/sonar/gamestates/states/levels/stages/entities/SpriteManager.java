...
public class SpriteManager
{
	...
	{
		voidSprite = new Sprite(new HUDSpriteBuilder(new SpriteSize(16, 16), 0xffff0000));
	}
	
	private void buildPassword()
	{
		voidSprite = new Sprite(new HUDSpriteBuilder(new SpriteSize(16, 16), 0xff00ff00));
	}
	
	private void buildInventory()
	{
		voidSprite = new Sprite(new HUDSpriteBuilder(new SpriteSize(16, 16), 0xff00ffff));
	}
