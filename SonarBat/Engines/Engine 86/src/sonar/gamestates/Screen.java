...
public class Screen
{
	...
	public void renderEnergy(Energy energy)
	{
		render(energy, energy.getX(), energy.getY(), energy.getWidth(), energy.getHeight());
	}
	
	public void renderWeapon(Weapon weapon)
	{
		render(weapon, weapon.getX(), weapon.getY(), weapon.getWidth(), weapon.getHeight());
	}
	
	public void renderMob(Mob mob)
	{
		render(mob, mob.getX(), mob.getY(), mob.getWidth(), mob.getHeight());
	}
	
	public void renderTile(Tile tile)
	{
		render(tile, tile.getX(), tile.getY(), tile.getWidth(), tile.getHeight());
	}
	
	private void render(Entity entity, int xp, int yp, int eWidth, int eHeight)
	{
		xp -= xOffset;
		yp -= yOffset;
