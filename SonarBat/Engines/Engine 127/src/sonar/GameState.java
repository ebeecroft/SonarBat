...
public abstract class GameState
{
	...
	private String identity; //No longer has use in this class
	...
	protected String getIdentity(){return identity;} //Keep around for a while
	public void setTiles(int[] values){tiles = values;}
	public void setWidth(int value){width = value;}
	public void setHeight(int value){height = value;}
	void setBuildState(StateBuilder state){buildState = state;}
}