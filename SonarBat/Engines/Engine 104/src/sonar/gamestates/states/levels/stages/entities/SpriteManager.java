...
public class SpriteManager
{
	...
	//Builds the SonarBat mob
	public Sprite sonarbatMobUp, sonarbatMobUp1, sonarbatMobUp2;
	public Sprite sonarbatMobDown, sonarbatMobDown1, sonarbatMobDown2;
	public Sprite sonarbatMobLeft, sonarbatMobLeft1, sonarbatMobLeft2;
	public Sprite sonarbatMobRight, sonarbatMobRight1, sonarbatMobRight2;
	...
	{
		SpriteSize sonarbatSize = new SpriteSize(20, 32);
		SpriteSheet sonarbat = new SpriteSheet("/textures/mobs/sonarbat/Player.png");
		SpriteSheet sonarbatSide = new SpriteSheet("/texturers/mobs/sonarbat/PlayerSide.png");
		sonarbatMobUp = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(0, 0, sonarbat), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobUp1 = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(0, 1, sonarbat), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobUp2 = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(0, 1, sonarbat), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobDown = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(1, 0, sonarbat), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobDown1 = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(1, 1, sonarbat), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobDown2 = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(1, 1, sonarbat), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobLeft = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(0, 0, sonarbatSide), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobLeft1 = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(1, 0, sonarbatSide), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobLeft2 = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(2, 0, sonarbatSide), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobRight = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(0, 0, sonarbatSide), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobRight1 = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(1, 0, sonarbatSide), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));
		sonarbatMobRight2 = new Sprite(new GreySpriteBuilder(sonarbatSize, new SpriteLocation(2, 0, sonarbatSide), 0xff000000, 0xff122336, 0xff285643, 0xff198924, 0xff322892));		
	}
