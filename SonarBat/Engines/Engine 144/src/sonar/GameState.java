...
public abstract class GameState
{
	...
	protected final void createGameState(final StateBuilder cBuild) //must be instance, was changed
	{
		buildState = cBuild;
	...
	private final void loadPath(String path)
	{
		try
		{
	...
	private final int tileColour(final int x, final int y){return tiles[x + y * width];}
	...
	public final void setTiles(int[] values){tiles = values;}
