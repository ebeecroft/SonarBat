...
public class TileManager
{
	...
	//Inventory and Password colours
	...
	public static final int squareColour = 0xff505050;
	...
	private void invpassCommons(SpriteManager manage)
	{
		...
		square = new Tile(new SquareTileBuilder(new StaticAnimation(manage.square)));
	}
...
class SquareTileBuilder extends TileBuilder
{
	SquareTileBuilder(AnimationType buildAnimation){super(buildAnimation);}
	String attribute(){return "Square";}
}